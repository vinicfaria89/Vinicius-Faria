...
const CSS = `
  ...
  * { box-sizing: border-box; }
  ...
  .sim-header .prod .nome { font-size:12.5px; font-weight:800; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; margin-top:1px; }
...
async function montarRelatorioOficial({ cliente, dataBase, ativosInput: ativosInputRaw, curvas, templateType, docTitleSuffix, assessor, medirAlturasCards }) {
  ...
  const jmTotalRow = (temCupomMensalDistribuido
    ? `<div class="metric-row jm"><span class="lbl">Renda Mensal (líq.)</span><span class="val">${brl2(rendaMensalTotal)}</span></div>`
  ...
  <div class="stats-extra-card">
    ...
    <div class="stat-item">
      <div class="stat-lbl">Duration (Macaulay)</div>
    ...
    <div class="stat-item">
      <div class="stat-lbl">Rentabilidade Anualizada Equivalente</div>
      <div class="stat-val">≈${pct2(rentAnualizadaPct)}% a.a. <span class="stat-sub">sobre o prazo médio ponderado</span></div>
    </div>
  </div>`;
